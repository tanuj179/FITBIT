...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary">Edit register Dietician
            <a href="dieticiantable.php" class="btn btn-danger"  >
              BACK
            </a>
    </h6>
  </div>
...
if(isset($_GET['user_id']))
{
    ...
    $query = "SELECT * FROM dietician WHERE id='$user_id' LIMIT 1";
